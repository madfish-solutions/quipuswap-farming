...
describe("BakerRegistry tests", async () => {
  ...
  it("should register new baker", async () => {
  ...
  it("should fail if the address to register is not a baker", async () => {
  ...
  it("should register new baker if baker is not already registered", async () => {
  ...
  it("should fail if the baker is not already registered and the address to register is not a baker", async () => {
